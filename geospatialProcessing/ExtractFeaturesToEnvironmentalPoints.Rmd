---
title: "Extract Features to Sample Points"
...
# -*- coding: utf-8 -*-
# ---------------------------------------------------------------------------
# Extract Features to Sample Points
...
# Description: "Extract Features to Sample Points" creates a csv table of features for all points in a sample set.
# ---------------------------------------------------------------------------
```
...
sample_folder = paste(root_directory, '/Data_Input/environmental_points', sep='')
...
output_folder = paste(root_directory, '/Data_Output/sample_environment', sep='')
```
