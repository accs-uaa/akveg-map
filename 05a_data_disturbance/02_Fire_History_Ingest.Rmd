...
```
Alaska, downloaded 2025-04-18:
https://fire.ak.blm.gov/predsvcs/maps.php
Data and Metadata -> Zipped Geodatabases
  Alaska Fire History PerimeterPolygons
...
```{r rasterize 30 m raster AK and Canada}
...
```{r rasterize 10m with smaller study area}
