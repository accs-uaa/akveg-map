...
mean_raw = os.path.join(processed_folder, 'full/SummerWarmth_MeanAnnual_Raw_2km_2000-2015.tif')
mean_interpolated = os.path.join(processed_folder, 'nab/SummerWarmth_MeanAnnual_Interpolated_2km_2000-2015.tif')
