...
# Description: "Download Sentinel-1 Data from Drive" programmatically downloads Sentinel-1 tiles from a Google Drive folder. The spectral composites must first be calculated in Google Earth Engine and exported to the Google Drive folder.
# ---------------------------------------------------------------------------
