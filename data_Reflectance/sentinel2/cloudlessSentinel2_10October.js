...
Export.image.toDrive({
  image: band_2_blue,
  description: 'Sent2_10October_2_blue',
...
Export.image.toDrive({
  image: band_3_green,
  description: 'Sent2_10October_3_green',
  folder: 'Beringia_Sentinel-2',
  scale: 10,
  region: areaOfInterest,
  maxPixels: 1e12
...
Export.image.toDrive({
  image: band_4_red,
  description: 'Sent2_10October_4_red',
  folder: 'Beringia_Sentinel-2',
  scale: 10,
  region: areaOfInterest,
  maxPixels: 1e12
...
Export.image.toDrive({
  ...
  description: 'Sent2_10October_5_redEdge1',
  folder: 'Beringia_Sentinel-2',
  scale: 20,
  region: areaOfInterest,
  maxPixels: 1e12
...
Export.image.toDrive({
  ...
  description: 'Sent2_10October_6_redEdge2',
  folder: 'Beringia_Sentinel-2',
  scale: 20,
  region: areaOfInterest,
  maxPixels: 1e12
...
Export.image.toDrive({
  ...
  description: 'Sent2_10October_7_redEdge3',
  folder: 'Beringia_Sentinel-2',
  scale: 20,
  region: areaOfInterest,
  maxPixels: 1e12
...
Export.image.toDrive({
  ...
  description: 'Sent2_10October_8_nearInfrared',
  folder: 'Beringia_Sentinel-2',
  scale: 10,
  region: areaOfInterest,
  maxPixels: 1e12
...
Export.image.toDrive({
  ...
  description: 'Sent2_10October_8a_redEdge4',
  folder: 'Beringia_Sentinel-2',
  scale: 20,
  region: areaOfInterest,
  maxPixels: 1e12
...
Export.image.toDrive({
  ...
  description: 'Sent2_10October_11_shortInfrared1',
  folder: 'Beringia_Sentinel-2',
  scale: 20,
  region: areaOfInterest,
  maxPixels: 1e12
...
Export.image.toDrive({
  ...
  description: 'Sent2_10October_12_shortInfrared2',
  folder: 'Beringia_Sentinel-2',
  scale: 20,
  region: areaOfInterest,
  maxPixels: 1e12
...
Export.image.toDrive({
  image: evi2,
  description: 'Sent2_10October_evi2',
  folder: 'Beringia_Sentinel-2',
  scale: 10,
  region: areaOfInterest,
  maxPixels: 1e12
...
Export.image.toDrive({
  image: nbr,
  description: 'Sent2_10October_nbr',
  folder: 'Beringia_Sentinel-2',
  scale: 20,
  region: areaOfInterest,
  maxPixels: 1e12
...
Export.image.toDrive({
  image: ndmi,
  description: 'Sent2_10October_ndmi',
  folder: 'Beringia_Sentinel-2',
  scale: 20,
  region: areaOfInterest,
  maxPixels: 1e12
...
Export.image.toDrive({
  image: ndsi,
  description: 'Sent2_10October_ndsi',
  folder: 'Beringia_Sentinel-2',
  scale: 20,
  region: areaOfInterest,
  maxPixels: 1e12
...
Export.image.toDrive({
  image: ndvi,
  description: 'Sent2_10October_ndvi',
  folder: 'Beringia_Sentinel-2',
  scale: 10,
  region: areaOfInterest,
  maxPixels: 1e12
...
Export.image.toDrive({
  image: ndwi,
  description: 'Sent2_10October_ndwi',
  folder: 'Beringia_Sentinel-2',
  scale: 10,
  region: areaOfInterest,
  maxPixels: 1e12
