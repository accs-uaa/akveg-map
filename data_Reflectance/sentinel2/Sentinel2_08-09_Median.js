...
var composite = cloudlessCollection.median();
...
Map.addLayer(composite, firVis, 'August-September Median Composite');
...
Export.image.toDrive({
  image: band_2_blue,
  description: 'Sent2_08-09_2_blue',
...
Export.image.toDrive({
  image: band_3_green,
  description: 'Sent2_08-09_3_green',
  folder: 'Beringia_Sentinel-2',
  scale: 10,
  region: areaOfInterest,
  maxPixels: 1e12
...
Export.image.toDrive({
  ...
  description: 'Sent2_08-09_5_redEdge1',
  folder: 'Beringia_Sentinel-2',
  scale: 20,
  region: areaOfInterest,
  maxPixels: 1e12
...
Export.image.toDrive({
  ...
  description: 'Sent2_08-09_6_redEdge2',
  folder: 'Beringia_Sentinel-2',
  scale: 20,
  region: areaOfInterest,
  maxPixels: 1e12
...
Export.image.toDrive({
  ...
  description: 'Sent2_08-09_7_redEdge3',
  folder: 'Beringia_Sentinel-2',
  scale: 20,
  region: areaOfInterest,
  maxPixels: 1e12
...
Export.image.toDrive({
  ...
  description: 'Sent2_08-09_8_nearInfrared',
  folder: 'Beringia_Sentinel-2',
  scale: 10,
  region: areaOfInterest,
  maxPixels: 1e12
...
Export.image.toDrive({
  ...
  description: 'Sent2_08-09_8a_redEdge4',
  folder: 'Beringia_Sentinel-2',
  scale: 20,
  region: areaOfInterest,
  maxPixels: 1e12
...
Export.image.toDrive({
  ...
  description: 'Sent2_08-09_11_shortInfrared1',
  folder: 'Beringia_Sentinel-2',
  scale: 20,
  region: areaOfInterest,
  maxPixels: 1e12
...
Export.image.toDrive({
  ...
  description: 'Sent2_08-09_12_shortInfrared2',
  folder: 'Beringia_Sentinel-2',
  scale: 20,
  region: areaOfInterest,
  maxPixels: 1e12
