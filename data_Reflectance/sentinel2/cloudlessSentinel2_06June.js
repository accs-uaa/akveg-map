...
Export.image.toDrive({
  image: band_2_blue,
  description: 'Sent2_06June_2_blue',
...
Export.image.toDrive({
  image: band_3_green,
  description: 'Sent2_06June_3_green',
  folder: 'Beringia_Sentinel-2',
  scale: 10,
  region: areaOfInterest,
  maxPixels: 1e12
...
Export.image.toDrive({
  image: band_4_red,
  description: 'Sent2_06June_4_red',
  folder: 'Beringia_Sentinel-2',
  scale: 10,
  region: areaOfInterest,
  maxPixels: 1e12
...
Export.image.toDrive({
  ...
  description: 'Sent2_06June_5_redEdge1',
  folder: 'Beringia_Sentinel-2',
  scale: 20,
  region: areaOfInterest,
  maxPixels: 1e12
...
Export.image.toDrive({
  ...
  description: 'Sent2_06June_6_redEdge2',
  folder: 'Beringia_Sentinel-2',
  scale: 20,
  region: areaOfInterest,
  maxPixels: 1e12
...
Export.image.toDrive({
  ...
  description: 'Sent2_06June_7_redEdge3',
  folder: 'Beringia_Sentinel-2',
  scale: 20,
  region: areaOfInterest,
  maxPixels: 1e12
...
Export.image.toDrive({
  ...
  description: 'Sent2_06June_8_nearInfrared',
  folder: 'Beringia_Sentinel-2',
  scale: 10,
  region: areaOfInterest,
  maxPixels: 1e12
...
Export.image.toDrive({
  ...
  description: 'Sent2_06June_8a_redEdge4',
  folder: 'Beringia_Sentinel-2',
  scale: 20,
  region: areaOfInterest,
  maxPixels: 1e12
...
Export.image.toDrive({
  ...
  description: 'Sent2_06June_11_shortInfrared1',
  folder: 'Beringia_Sentinel-2',
  scale: 20,
  region: areaOfInterest,
  maxPixels: 1e12
...
Export.image.toDrive({
  ...
  description: 'Sent2_06June_12_shortInfrared2',
  folder: 'Beringia_Sentinel-2',
  scale: 20,
  region: areaOfInterest,
  maxPixels: 1e12
