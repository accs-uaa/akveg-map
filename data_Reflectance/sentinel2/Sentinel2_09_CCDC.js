/* -*- coding: utf-8 -*-
---------------------------------------------------------------------------
End of Growing Season (September 20, 2019) Composite of Sentinel 2 Imagery
...
Description: This script produces a predicted normal composite representing the end of growing season as September 20, 2019, using the Continuous Change Detection and Classification (CCDC) algorithm for bands 1-12 plus Enhanced Vegetation Index-2 (EVI2), Normalized Burn Ratio (NBR), Normalized Difference Moisture Index (NDMI), Normalized Difference Snow Index (NDSI), Normalized Difference Vegetation Index (NDVI), and Normalized Difference Water Index (NDWI) using the Sentinel-2 Top-Of-Atmosphere image collection (2015-2020). Pixels that could not be predicted using CCDC are filled from a median composite for August 25-October 15 2015-2020.
---------------------------------------------------------------------------*/
...
var filter_1 = ee.Filter.date('2015-08-25', '2015-10-15')
var filter_2 = ee.Filter.date('2016-08-25', '2016-10-15')
var filter_3 = ee.Filter.date('2017-08-25', '2017-10-15')
var filter_4 = ee.Filter.date('2018-08-25', '2018-10-15')
var filter_5 = ee.Filter.date('2019-08-25', '2019-10-15')
var filter_6 = ee.Filter.date('2020-08-25', '2020-10-15')
...
Export.image.toAsset({
  ...
  description: 'test_20190920',
  assetId: 'users/twnawrocki/test_20190920',
  region: areaTest,
  scale: 10,
  maxPixels: 1e12
});
...
var testAsset = ee.Image('users/twnawrocki/test_20190920')
...
Export.image.toDrive({
  ...
  folder: 'Beringia_Sentinel-2_September',
  scale: 10,
