...
Export.image.toDrive({
  image: band_4_red,
  description: 'Sent2_07July_4_red',
  folder: 'Beringia_Sentinel-2',
  scale: 10,
  region: areaOfInterest,
  maxPixels: 1e12
...
Export.image.toDrive({
  ...
  description: 'Sent2_07July_5_redEdge1',
  folder: 'Beringia_Sentinel-2',
  scale: 20,
  region: areaOfInterest,
  maxPixels: 1e12
...
Export.image.toDrive({
  ...
  description: 'Sent2_07July_6_redEdge2',
  folder: 'Beringia_Sentinel-2',
  scale: 20,
  region: areaOfInterest,
  maxPixels: 1e12
...
Export.image.toDrive({
  ...
  description: 'Sent2_07July_7_redEdge3',
  folder: 'Beringia_Sentinel-2',
  scale: 20,
  region: areaOfInterest,
  maxPixels: 1e12
...
Export.image.toDrive({
  ...
  description: 'Sent2_07July_8_nearInfrared',
  folder: 'Beringia_Sentinel-2',
  scale: 10,
  region: areaOfInterest,
  maxPixels: 1e12
...
Export.image.toDrive({
  ...
  description: 'Sent2_07July_8a_redEdge4',
  folder: 'Beringia_Sentinel-2',
  scale: 20,
  region: areaOfInterest,
  maxPixels: 1e12
...
Export.image.toDrive({
  ...
  description: 'Sent2_07July_11_shortInfrared1',
  folder: 'Beringia_Sentinel-2',
  scale: 20,
  region: areaOfInterest,
  maxPixels: 1e12
...
Export.image.toDrive({
  ...
  description: 'Sent2_07July_12_shortInfrared2',
  folder: 'Beringia_Sentinel-2',
  scale: 20,
  region: areaOfInterest,
  maxPixels: 1e12
