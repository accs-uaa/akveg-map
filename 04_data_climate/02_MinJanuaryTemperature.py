...
january_output = os.path.join(processed_folder, 'January_MinimumTemperature_2006_2015_10m_3338.tif')
...
print('Calculating mean annual minimum january temperature...')
...
arcpy.management.CopyRaster(extract_integer,
                            ...
                            'TIFF',
                            'NONE')
arcpy.management.BuildPyramids(january_output,
                               '-1',
                               'NONE',
                               'BILINEAR',
                               'LZ77',
                               '',
                               'OVERWRITE')
arcpy.management.CalculateStatistics(january_output)
end_timing(iteration_start)
