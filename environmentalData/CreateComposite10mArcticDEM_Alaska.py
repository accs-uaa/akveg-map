# -*- coding: utf-8 -*-
# ---------------------------------------------------------------------------
# Create Composite 10 m Arctic DEM for Alaska
# Author: Timm Nawrocki
# Created on: 2019-10-19
# Usage: Must be executed in an ArcGIS Pro Python 3.6 installation.
# Description: "Create Composite 10 m Arctic DEM for Alaska" combines individual DEM tiles, reprojects to NAD 1983 Alaska Albers, and resamples to 10 m.
# ---------------------------------------------------------------------------
...
arctic10m_composite = os.path.join(root_directory, 'Alaska_ArcticDEM_Elevation_10m_AKALB_20191022.tif')
