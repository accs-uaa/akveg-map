...
data_folder = os.path.join(drive,
                           root_folder,
                           'Data_Output/model_results', round_date)

# Define output data
performance_output = os.path.join(data_folder, 'performance_table.csv')

# Define pre-determined field values
indicators = ['alnus', 'bderishr', 'betshr', 'bettre', 'brotre', 'chaang', 'dryas', 'dsalix', 'empnig', 'erivag', 
...
model_types = ['lgbm', 'lgbm', 'lgbm', 'lgbm', 'lgbm', 'lgbm', 'lgbm', 'lgbm', 'lgbm', 'lgbm',
               'lgbm', 'lgbm', 'lgbm', 'lgbm', 'lgbm', 'lgbm', 'lgbm', 'lgbm', 'lgbm', 'lgbm',
               'lgbm', 'lgbm', 'lgbm', 'lgbm', 'lgbm', 'lgbm', 'lgbm', 'lgbm', 'lgbm']
life_forms = ['shrub', 'shrub', 'shrub', 'tree', 'tree', 'herbaceous', 'dwarf shrub', 'dwarf shrub', 'dwarf shrub', 'herbaceous',
              'herbaceous', 'herbaceous', 'herbaceous', 'shrub', 'dwarf shrub', 'tree', 'tree', 'tree', 'tree', 'tree',
              'dwarf shrub', 'herbaceous', 'shrub', 'herbaceous', 'moss', 'tree', 'shrub', 'dwarf shrub', 'herbaceous']
