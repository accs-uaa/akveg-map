...
ak_above <- read_sf(path(w, 'gis_projects/2019/19-301_ABoVE_Biome_Shift/akvegmap_v2/studyAreas',
...
akcan_above_firepoly_3338 <- bind_rows(ak_firepoly, can_firepoly_3338_akabove) %>%
  arrange(fire_year)
write_sf(akcan_firepoly_3338, path(w, 'vector_base/Alaska/Statewide/Fire/akcan_above_firepoly_thru_2023_v20240309.shp'))
...
akcan_fire_rast <- rasterize(akcan_firepoly_3338_vect, fire_30m_3338, 'fire_year', fun='max', datatype='INT2U',
                          filename='/data/gis/gis_projects/2019/19-301_ABoVE_Biome_Shift/akvegmap_v2/flt32_mrfy_akcan_1917_2023_30m_3338_v20240309.tif')

gdal_translate('/data/gis/gis_projects/2019/19-301_ABoVE_Biome_Shift/akvegmap_v2/flt32_mrfy_akcan_1917_2023_30m_3338_v20240309.tif',
               '/data/gis/gis_projects/2019/19-301_ABoVE_Biome_Shift/akvegmap_v2/mrfy_akcan_1917_2023_30m_3338_v20240309.tif',
