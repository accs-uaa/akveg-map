# -*- coding: utf-8 -*-
# ---------------------------------------------------------------------------
# Calculate mean annual precipitation for 2006-2015
...
precip_output = os.path.join(processed_folder, 'Precipitation_MeanAnnual_2006_2015_10m_3338.tif')
...
arcpy.management.CopyRaster(extract_integer,
                            ...
                            'TIFF',
                            'NONE')
arcpy.management.BuildPyramids(precip_output,
                               '-1',
                               'NONE',
                               'BILINEAR',
                               'LZ77',
                               '',
                               'OVERWRITE')
arcpy.management.CalculateStatistics(precip_output)
end_timing(iteration_start)
