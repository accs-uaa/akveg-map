# -*- coding: utf-8 -*-
# ---------------------------------------------------------------------------
# Calculate minimum January temperature for 2006-2015
# Author: Timm Nawrocki
# Last Updated: 2026-01-18
# Usage: Must be executed in a Python 3.12+ installation.
# Description: "Calculate minimum January temperature for 2006-2015" calculates the minimum January temperature mean for years 2006-2015. The primary data are the SNAP Alaska-Yukon 2km data with the included portion of the Northwest Territories interpolated by geographic nearest neighbors.
# ---------------------------------------------------------------------------
...
climate_folder = os.path.join(data_folder, 'unprocessed/tasmin_2km_TS40')
...
january_intermediate = os.path.join(processed_folder,
                                    'JanuaryMinimum_2006_2015_2km_3338.tif')
january_filled = os.path.join(processed_folder,
                              'JanuaryMinimum_2006_2015_2km_3338_Filled.tif')

# Define output datasets
january_output = os.path.join(processed_folder,
                              'JanuaryMinimum_2006_2015_10m_3338.tif')
...
with rasterio.open(january_intermediate, 'w', **output_profile) as dst:
...
climate_raster = rasterio.open(january_filled)
...
with rasterio.open(january_output, 'w', **output_profile) as dst:
    # Find number of raster blocks
...
os.remove(january_intermediate)
os.remove(january_filled)
