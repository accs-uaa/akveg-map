...
presence_data = cover_data %>%
  filter(name_accepted == 'Eriophorum vaginatum' |
           name_accepted == 'Eriophorum vaginatum ssp. vaginatum') %>%
...
presence_data = presence_data %>%
  ...
  mutate(name_accepted = 'Eriophorum vaginatum') %>%
...
output_csv = paste(data_folder, 'species_data/mapClass_erivag.csv', sep = '/')
