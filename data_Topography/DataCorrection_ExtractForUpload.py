# -*- coding: utf-8 -*-
# ---------------------------------------------------------------------------
# Extract Topographic Data For Upload
...
input_grids = os.path.join(data_folder, 'analyses/GridMajor_NoBuffer')
...
for grid in grid_list:
    ...
    for input_raster in raster_list:
        ...
        output_raster = input_raster.replace('gridded_full', 'upload')
