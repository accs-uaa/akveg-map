# -*- coding: utf-8 -*-
# ---------------------------------------------------------------------------
# Prepare Class Data - Cetraria
# Author: Timm Nawrocki
# Created on: 2020-05-16
# Usage: Must be executed in R 4.0.0+.
# Description: "Prepare Class Data - Cetraria" prepares the map class data for statistical modeling.
# ---------------------------------------------------------------------------
...
presence_sites = presence_sites %>%
  ...
  mutate(nameAccepted = 'Cetraria') %>%
  mutate(genus = 'Cetraria') %>%
  mutate(zero = 1)
...
output_csv = paste(data_folder, 'species_data/mapClass_Cetraria.csv', sep = '/')
