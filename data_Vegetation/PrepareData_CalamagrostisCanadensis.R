...
presence_data = cover_data %>%
  filter(name_accepted == 'Calamagrostis canadensis' |
           name_accepted == 'Calamagrostis canadensis ssp. canadensis' |
           name_accepted == 'Calamagrostis canadensis ssp. langsdorffii') %>%
...
presence_data = presence_data %>%
  ...
  mutate(name_accepted = 'Calamagrostis canadensis') %>%
...
remove_sites = cover_data %>%
  filter((name_accepted == 'Calamagrostis' |
