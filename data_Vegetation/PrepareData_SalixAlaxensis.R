# -*- coding: utf-8 -*-
# ---------------------------------------------------------------------------
# Prepare Class Data - Salix alaxensis
# Author: Timm Nawrocki
# Created on: 2020-05-16
# Usage: Must be executed in R 4.0.0+.
# Description: "Prepare Class Data - Salix alaxensis" prepares the map class data for statistical modeling.
# ---------------------------------------------------------------------------
...
presence_sites = presence_sites %>%
  ...
  mutate(nameAccepted = 'Salix alaxensis') %>%
  mutate(genus = 'Salix') %>%
  mutate(zero = 1)
...
output_csv = paste(data_folder, 'species_data/mapClass_SalixAlaxensis.csv', sep = '/')
