# -*- coding: utf-8 -*-
# ---------------------------------------------------------------------------
# Prepare Class Data - Viburnum edule
# Author: Timm Nawrocki
# Created on: 2020-05-16
# Usage: Must be executed in R 4.0.0+.
# Description: "Prepare Class Data - Viburnum edule" prepares the map class data for statistical modeling.
# ---------------------------------------------------------------------------
...
presence_sites = species_data %>%
  filter(nameAccepted == 'Viburnum edule') %>%
...
absence_sites = site_data['siteCode'] %>%
  ...
  mutate(nameAccepted = 'Viburnum edule') %>%
...
output_csv = paste(data_folder, 'species_data/mapClass_ViburnumEdule.csv', sep = '/')
