...
presence_data = species_data %>%
  filter(nameAccepted == 'Vaccinium vitis-idaea' |
           nameAccepted == 'Vaccinium vitis-idaea ssp. minus') %>%
...
presence_data = presence_data %>%
  ...
  mutate(nameAccepted = 'Vaccinium vitis-idaea') %>%
...
output_csv = paste(data_folder, 'species_data/mapClass_VacciniumVitisidaea.csv', sep = '/')
