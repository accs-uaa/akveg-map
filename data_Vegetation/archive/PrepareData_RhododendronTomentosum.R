# -*- coding: utf-8 -*-
# ---------------------------------------------------------------------------
# Prepare Class Data - Rhododendron tomentosum-groenlandicum
# Author: Timm Nawrocki
# Created on: 2020-05-25
# Usage: Must be executed in R 4.0.0+.
# Description: "Prepare Class Data - Rhododendron tomentosum-groenlandicum" prepares the map class data for statistical modeling.
# ---------------------------------------------------------------------------
