# -*- coding: utf-8 -*-
# ---------------------------------------------------------------------------
# Prepare Class Data - Rhododendron tomentosum ssp. decumbens
# Author: Timm Nawrocki
# Created on: 2020-05-16
# Usage: Must be executed in R 4.0.0+.
# Description: "Prepare Class Data - Rhododendron tomentosum ssp. decumbens" prepares the map class data for statistical modeling.
# ---------------------------------------------------------------------------
...
presence_sites = species_data %>%
  filter(nameAccepted == 'Rhododendron tomentosum ssp. decumbens' |
           nameAccepted == 'Rhododendron tomentosum' |
           nameAccepted == 'Rhododendron groenlandicum' |
           nameAdjudicated == 'Ledum') %>%
...
presence_sites = presence_sites %>%
  ...
  mutate(nameAccepted = 'Rhododendron tomentosum-groenlandicum') %>%
...
output_csv = paste(data_folder, 'species_data/mapClass_RhododendronTomentosum.csv', sep = '/')
