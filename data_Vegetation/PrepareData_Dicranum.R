# -*- coding: utf-8 -*-
# ---------------------------------------------------------------------------
# Prepare Class Data - Dicranum
# Author: Timm Nawrocki
# Created on: 2020-05-16
# Usage: Must be executed in R 4.0.0+.
# Description: "Prepare Class Data - Dicranum" prepares the map class data for statistical modeling.
# ---------------------------------------------------------------------------
...
presence_sites = presence_sites %>%
  ...
  mutate(nameAccepted = 'Dicranum') %>%
  mutate(genus = 'Dicranum') %>%
  mutate(zero = 1)
...
output_csv = paste(data_folder, 'species_data/mapClass_Dicranum.csv', sep = '/')
