# -*- coding: utf-8 -*-
# ---------------------------------------------------------------------------
# Prepare Class Data - Ericaceous Needleleaf Shrubs
# Author: Timm Nawrocki
# Last Updated: 2021-03-15
# Usage: Must be executed in R 4.0.0+.
# Description: "Prepare Class Data - Ericaceous Needleleaf Shrubs" prepares the map class data for statistical modeling.
# ---------------------------------------------------------------------------
...
presence_data = cover_data %>%
  filter(name_accepted == 'Cassiope' |
           name_accepted == 'Cassiope lycopodioides' |
           name_accepted == 'Cassiope mertensiana' |
           name_accepted == 'Cassiope tetragona' |
           name_accepted == 'Cassiope tetragona ssp. saximontana' |
           name_accepted == 'Cassiope tetragona ssp. tetragona' |
           name_accepted == 'Empetrum' |
           name_accepted == 'Empetrum nigrum' |
           name_accepted == 'Harrimanella' |
           name_accepted == 'Harrimanella stelleriana' |
           name_accepted == 'Phyllodoce' |
           name_accepted == 'Phyllodoce aleutica' |
           name_accepted == 'Phyllodoce caerulea' |
           name_accepted == 'Phyllodoce empetriformis' |
           name_accepted == 'Phyllodoce glanduliflora') %>%
...
presence_data = presence_data %>%
  ...
  mutate(name_accepted = 'Ericaceous Needleleaf') %>%
  mutate(genus = 'Ericaceous Needleleaf') %>%
...
output_csv = paste(data_folder, 'species_data/mapClass_erinee.csv', sep = '/')
