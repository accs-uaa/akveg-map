# -*- coding: utf-8 -*-
# ---------------------------------------------------------------------------
# Prepare Class Data - Vaccinium uliginosum
# Author: Timm Nawrocki
# Last Updated: 2021-03-21
# Usage: Must be executed in R 4.0.0+.
# Description: "Prepare Class Data - Vaccinium uliginosum" prepares the map class data for statistical modeling.
# ---------------------------------------------------------------------------
...
presence_data = cover_data %>%
  filter(name_accepted == 'Vaccinium uliginosum' |
           name_accepted == 'Vaccinium uliginosum ssp. microphyllum' |
           name_accepted == 'Vaccinium uliginosum ssp. occidentale' |
           name_accepted == 'Vaccinium uliginosum ssp. pedris' |
           name_accepted == 'Vaccinium uliginosum ssp. vulcanorum') %>%
...
presence_data = presence_data %>%
  ...
  mutate(name_accepted = 'Vaccinium uliginosum') %>%
...
output_csv = paste(data_folder, 'species_data/mapClass_vaculi.csv', sep = '/')
