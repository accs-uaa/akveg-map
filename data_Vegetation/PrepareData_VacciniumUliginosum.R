...
presence_data = species_data %>%
  filter(nameAccepted == 'Vaccinium uliginosum' |
           nameAccepted == 'Vaccinium uliginosum ssp. microphyllum' |
           nameAccepted == 'Vaccinium uliginosum ssp. pedris') %>%
...
output_csv = paste(data_folder, 'species_data/mapClass_VacciniumUliginosum.csv', sep = '/')
