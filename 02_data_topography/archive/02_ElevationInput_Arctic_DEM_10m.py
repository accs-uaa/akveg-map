# -*- coding: utf-8 -*-
# ---------------------------------------------------------------------------
# Process Arctic DEM 10 m tiles
# Author: Timm Nawrocki
# Last Updated: 2023-10-10
# Usage: Execute in Python 3.9+.
# Description: "Process Arctic DEM 10 m tiles" combines individual DEM tiles to a single raster, resamples to 10 m, and replaces erroneous values.
# ---------------------------------------------------------------------------
...
input_folder = os.path.join(data_folder, 'Arctic_DEM_10m', 'unprocessed')
output_folder = os.path.join(data_folder, 'Arctic_DEM_10m', 'processed')
...
# Define output files
output_file = os.path.join(output_folder, 'Arctic_DEM_10m_3338.tif')
